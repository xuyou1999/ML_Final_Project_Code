...
class Net(nn.Module):
    ...
    def forward(self, data):
        ...
        out = self.hidden4(F.relu(out))
        out = self.hidden5(F.relu(out))
        out = self.hidden6(F.relu(out))
        out = self.hidden7(F.relu(out))
        out = self.hidden8(F.relu(out))
        out = self.hidden9(F.relu(out))
        out = self.hidden10(F.relu(out))
